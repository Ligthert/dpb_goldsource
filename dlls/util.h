...
#else
  #define MAKE_STRING(str) atoi(str)
#endif
...
#define vecadd(a,b) (a[0]+=b[0],a[1]+=b[1],a[2]+=b[2])
#define vecsub(a,b) (a[0]-=b[0],a[1]-=b[1],a[2]-=b[2])
#define vecmul(a,b) (a[0]*=b,a[1]*=b,a[2]*=b)
...
extern float		UTIL_AngleDistance( float next, float cur );
  ...
  extern void			UTIL_ShowVgui(entvars_t *ent,int menu);
...
#define VEC_VIEW			Vector( 0, 0, 32 )

#define VEC_DUCK_HULL_MIN	Vector(-16, -16, -18 )
#define VEC_DUCK_HULL_MAX	Vector( 16,  16,  30)
#define VEC_DUCK_VIEW		Vector( 0, 0,  25)
